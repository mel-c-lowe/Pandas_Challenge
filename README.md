...
* A table that highlights the bottom 5 performing schools based on % Overall Passing. Including the previously included metrics.

### Math Scores by Grade

* Atable that lists the average Math Score for students of each grade level (9th, 10th, 11th, 12th) at each school.
...
* A table with the same breakdown as above but separating schools by size (small, medium, large).

### Scores by School Type

* A table with the same breakdown as above but separating schools by type (Charter vs. District).
